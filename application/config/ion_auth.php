 ...
 */
$config['site_title']                 = "Dashboard Home";       // Site Title, example.com
$config['admin_email']                = "ryan_w_frank@mac.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 43250;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
